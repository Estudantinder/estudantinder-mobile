...
import EditStudentAboutSubmit from 'packages/edit-target-info/controllers/AboutSubmit'
import EditStudentAbout from 'packages/edit-target-info/pages/About'
